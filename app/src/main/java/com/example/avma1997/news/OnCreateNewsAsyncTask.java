...
/**
 * Created by Avma1997 on 7/13/2017.
 */
...
public class OnCreateNewsAsyncTask extends AsyncTask<String, Void, ArrayList<News>> {
    ...
    protected void onPostExecute(ArrayList<News> Newslist) {
        ...
        if (mListener != null) {
            mListener.onDownloadComp(Newslist);
        }
    }
}
...
interface OnDownloadCompListener {
    ...
    void onDownloadComp(ArrayList<News> Newslist);
